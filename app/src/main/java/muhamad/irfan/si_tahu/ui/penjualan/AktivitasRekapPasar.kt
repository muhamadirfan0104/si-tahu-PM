...
class AktivitasRekapPasar : AktivitasDasar() {
    ...
    private fun setupView() {
        ...
        binding.spChannel.adapter = AdapterSpinner.stringAdapter(this, listOf("PASAR", "RESELLER"))
        ...
        lifecycleScope.launch {
            runCatching { RepositoriFirebaseUtama.muatProdukAktif() }
                .onSuccess {
                    ...
                    binding.spProduct.adapter = AdapterSpinner.stringAdapter(this@AktivitasRekapPasar, labels)
                    updateChannelPrice()
                }
                .onFailure {
